  ...
  return (
    <div className="w-full flex flex-col gap-6 animate-fadeIn pb-24">
      ...
      <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 p-1.5 rounded-2xl bg-card border border-border w-full sm:w-fit shadow-xs">
        ...
        >
          <Bot size={14} /> Swarm Agents ({Object.values(agentState).filter(Boolean).length}/9)
        </button>
        ...
        >
          <BarChart3 size={14} /> API & Model Usage
        </button>
      </div>
      ...
      {subTab === 'profile' && (
        <>
          ...
          <form onSubmit={handleSave} className="grid grid-cols-1 md:grid-cols-2 gap-6 items-stretch">
            ...
            >
              <div>
                ...
                <div className="flex flex-col gap-3">
                  <label className="block text-xs sm:text-[12.5px] font-bold uppercase tracking-wider text-muted-foreground">
          ...
          {/* AI-Extracted Personalized Memory Facts */}
          <div
