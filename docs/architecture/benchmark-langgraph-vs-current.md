...
| Stub absolute overhead (p50 ≤20ms, p95 ≤30ms) | PASS | overhead p50 8.024ms, p95 10.223ms (ratios 1.0973 / 1.123) |
...
|----------|----------|----------|
| Current | 82.445 | 83.101 |
| LangGraph | 90.469 | 93.324 |
| Absolute overhead | 8.024 | 10.223 |
