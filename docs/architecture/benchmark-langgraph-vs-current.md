...
| Stub absolute overhead (p50 ≤20ms, p95 ≤30ms) | PASS | overhead p50 6.727ms, p95 10.685ms (ratios 1.0817 / 1.1284) |
...
|----------|----------|----------|
| Current | 82.374 | 83.207 |
| LangGraph | 89.101 | 93.891 |
| Absolute overhead | 6.727 | 10.685 |
