...
| Stub absolute overhead (p50 ≤20ms, p95 ≤30ms) | PASS | overhead p50 5.405ms, p95 7.337ms (ratios 1.0655 / 1.0883) |
...
|----------|----------|----------|
| Current | 82.497 | 83.05 |
| LangGraph | 87.902 | 90.387 |
| Absolute overhead | 5.405 | 7.337 |
