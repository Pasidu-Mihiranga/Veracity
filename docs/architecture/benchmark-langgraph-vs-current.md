...
| Stub absolute overhead (p50 ≤20ms, p95 ≤30ms) | PASS | overhead p50 5.571ms, p95 7.654ms (ratios 1.0675 / 1.0923) |
...
|----------|----------|----------|
| Current | 82.492 | 82.914 |
| LangGraph | 88.062 | 90.568 |
| Absolute overhead | 5.571 | 7.654 |
